...
def numeric_deriv2(func, theta0, nx, ny, nz):
    """
    This function computes the matricies AA-MM in the "simple" linearization of
    the equations in the function 'func'.  (i.e. NOT log-linearized)
